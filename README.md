## [CAPACTOR C12](https://github.com/arnytrty/DevC3/issues/2) IS IN WRONG POSITION AND BRINGS PARASITE CAPACITANCE TO THE PI-MATCH THUS WIFI IS NOT WORKING, ALSO SOFTWARE RESET IS UNSTABLE FOR SOME REASON
